...
results are qualitatively similar when only total sperm length is included in the set
...
orchard_plot(m1a, mod = "PC_type", group = "Study_ID", data = dat_SLtotala, xlab = "Zr", alpha=0.4, transfm = "tanh")+ ylim(-1,1) +
  theme(axis.text.y = element_text(angle = 45)) 
...
orchard_plot(m4a, mod = "PC_type", group = "Study_ID", data = dat3a, xlab = "Zr", alpha=0.4, transfm = "tanh")+ ylim(-1,1) +
  theme(axis.text.y = element_text(angle = 45)) 
#external fert

dat3b <- subset(dat_SLtotala, Fertilisation_mode == "internal")
...
orchard_plot(m4b, mod = "PC_type", group = "Study_ID", data = dat3b, xlab = "Zr", alpha=0.4, transfm = "tanh")+ ylim(-1,1) +
  theme(axis.text.y = element_text(angle = 45)) 
```