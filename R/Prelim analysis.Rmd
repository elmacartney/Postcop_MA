...
fig.4a <- orchard_plot(m1, mod = "PC_type", group = "Study_ID", data = dat1, xlab = "Correlation (r)", alpha=0.4, transfm = "tanh") +
  ...
  ggtitle('Post-copulatory trait as moderator in global model') +
...
fig.4c <- orchard_plot(m4a, mod = "PC_type", group = "Study_ID", data = dat3, xlab = "Correlation (r)", alpha=0.4, transfm = "tanh")+ ylim(-1,2) +
  theme(axis.text.y = element_text(angle = 45)) +
...
fig.4d <- orchard_plot(m4b, mod = "PC_type", group = "Study_ID", data = dat4, xlab = "Correlation (r)", alpha=0.4, transfm = "tanh")+ ylim(-1,2) +
  theme(axis.text.y = element_text(angle = 45)) +
...
```{r,}
fig.5 <- orchard_plot(m2, mod = "PC_variation_cause2", group = "Study_ID", data = dat, xlab = "zr", alpha=0.4) +
  theme(axis.text.y = element_text(angle = 45)) +
