...
contra_fert <- contrast_fun(data = dat, response = yi, moderator = Fertilisation_mode,
    VCV = VCV)

res_table_mod <- get_estimate(model = m2b, contra = contra_fert, moderator = Fertilisation_mode)
