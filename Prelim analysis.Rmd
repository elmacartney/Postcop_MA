...
m4a <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  random = list(~1|Study_ID,                        ~1|Effectsize_ID, ~1|Species),
             R=list(Species = VCV_species),
             test = "t",
             data = dat3)
...
m4b <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  random = list(~1|Study_ID,                        ~1|Effectsize_ID, ~1|Species),
             R=list(Species = VCV_species),
             test = "t",
             data = dat4)
...
m6a <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  random = list(~1|Study_ID,                        ~1|Effectsize_ID, ~1|Species),
             R=list(Species = VCV_species),
             test = "t",
             data = dat5)
...
m6b <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  random = list(~1|Study_ID,                        ~1|Effectsize_ID, ~1|Species),
             R=list(Species = VCV_species),
             test = "t",
             data = dat6)
