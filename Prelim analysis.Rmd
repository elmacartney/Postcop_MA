...
m0b <- rma.mv(yi = yi, V = vi, random = list(~1|Study_ID,
                                            ~1|Effectsize_ID),
                                            #~1|Species,
                                            #~1|Phylogeny),
             #R=list(Phylogeny = VCV_species),
...
# TODO - conducting the likelihood ratio tests - use anova(mod1, mod2)
...
m1 <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  
             random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m2 <- rma.mv(yi = yi, V = vi, mod = ~PC_variation_cause-1,  
             random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m3 <- rma.mv(yi = yi, V = vi, mod = ~Rearing_type-1,  
             random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m4 <- rma.mv(yi = yi, V = vi, mod = ~Fertilisation_mode-1,  
             random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m4c <- rma.mv(yi = yi, V = vi, mod = ~Fert_trait-1,  
             random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m4a <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  
              random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m4b <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  
              random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m6 <- rma.mv(yi = yi, V = vi, mod = ~Competition_order-1,  
             random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m6a <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  
              random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
...
m6b <- rma.mv(yi = yi, V = vi, mod = ~PC_type-1,  
              random = list(~1|Study_ID,
                          ~1|Effectsize_ID,
                          ~1|Species,
                         ~1|Phylogeny),
