...
VCV2 <- impute_covariance_matrix(vi = dat5$vi, cluster = dat5$Study_ID, r = 0.5)
...
res4 <- mod_results(m4_MR, mod = "Fertilisation_mode", data = dat5, group = "Study_ID")

fig.4a <- orchard_plot(res5, mod = "Fertilisation_mode", group = "Study_ID", data = dat5, xlab = "Correlation (r)", alpha=0.4, transfm = "tanh")+ ylim(-1,1.25) +
  theme(axis.text.y = element_text(angle = 45)) +
...
res5 <- mod_results(m6_MR, mod = "Fertilisation_mode", data = dat7, group = "Study_ID")

fig.4c <- orchard_plot(res5, mod = "Fertilisation_mode", group = "Study_ID", data = dat7, xlab = "Correlation (r)", alpha=0.4, transfm = "tanh")+ ylim(-1,1.25) +
  theme(axis.text.y = element_text(angle = 45))+
